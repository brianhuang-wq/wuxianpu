...
<div class="top"><div class="inner">
  <h1>樂活五線譜　股價位階分析</h1>
  <div class="tagline">資料截至 __ASOF__（僅含已收盤價格）　·　免安裝，所有運算在本機瀏覽器完成</div>
  <div class="row">
    <div class="fld">
      <label for="tk">股票</label>
      <select id="tk" onchange="go()"></select>
    </div>
    <div class="fld">
...
function go() {
  const d = DATA[+document.getElementById('tk').value];
